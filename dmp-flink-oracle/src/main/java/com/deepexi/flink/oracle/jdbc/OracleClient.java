package com.deepexi.flink.oracle.jdbc;
...
import com.deepexi.flink.oracle.utils.OracleDialect;
...
public class OracleClient implements Serializable {
 ...
 /*           if (connection != null) {
    ...
    public  boolean tableExists(String owner, String tableName) throws SQLException {
        getConnection();
       String sql="select  count(1) cnt from all_tables t  where t.OWNER=? and t.TABLE_NAME =?";
       Object[] array={owner.toUpperCase(),tableName.toUpperCase()} ;
        List<Map<String, String>> cnt= this.executeQuery(sql,array);
    ...
    public OracleTable getTable( String owner,String tableName) throws SQLException {
        ...
        Object[] array={owner.toUpperCase(),tableName.toUpperCase()} ;
        List<Map<String, String>> list= this.executeQuery(sql,array);
